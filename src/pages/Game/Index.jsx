...
const images = [
  {
    id: 1,
    url: require("./assets/pictures/1.png"),
    is_sign: 1,
  },
  {
    id: 2,
    url: require("./assets/pictures/2.png"),
    is_sign: 2,
  },
  {
    id: 3,
    url: require("./assets/pictures/3.png"),
    is_sign: 3,
  },
  {
    id: 4,
    url: require("./assets/pictures/4.png"),
    is_sign: 4,
  },
  {
    id: 5,
    url: require("./assets/pictures/5.png"),
    is_sign: 5,
  },
  {
    id: 6,
    url: require("./assets/pictures/6.png"),
    is_sign: 6,
  },
  {
    id: 7,
          ...
          if (item === "无") {
            ...
            return (
              <Card
                ...
                index={index}
                content={item}
                imgUrl={images[item - 1].url} // 使用图片数组中的对应URL
