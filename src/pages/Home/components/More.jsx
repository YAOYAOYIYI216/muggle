    ...
    <View>
      ...
      <View style={{
        ...
        <View style={{
          ...
          <Image src={require('../assets/pictures/feedback.png')} onClick={() => handleClick(
            '问题反馈',
           '',
            '确认', () => {
            //反馈提交
            } )}/>
          <Image src={require('../assets/pictures/information.png')} onClick={() => handleClick(
            '参考资料',
            '',
            '确认', () => {
              //弹窗消失
            })} />
          <Image src={require('../assets/pictures/exit.png')} onClick={() => handleClick(
            '退出登录',
            '您确定要退出码？',
            '确认', () => {
              //退出登录
